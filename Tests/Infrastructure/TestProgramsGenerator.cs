...
namespace Tests.Infrastructure
{
    static class TestProgramsGenerator
    {
        ...
        public static List<bool> GetPolisConditionIndexes(TestSourceKey key) =>
            key switch
            {
                TestSourceKey.Simple => 
                ...
                TestSourceKey.If => 
                    new List<bool>() { false, false, false, false, false, false, true, true, true, true, true, true,
                        true, true, false },
                
                TestSourceKey.IfElse => 
                    new List<bool>() { false, false, false, true, true, true, true, true, true, true, true, true,
                        true, true, true, true, false },
                
                TestSourceKey.NestedConditions => 
                    new List<bool>() { false, false, false, true, true, true, true, true, true, true, true, true, true,
                ...
                TestSourceKey.CycleForWithCondition => 
                    new List<bool>() { false, false, false, false, false, false, false, false, false, true, true, true,
                        true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true,
                        true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true,
                        true, true, true, true, true, true, false },
                ...
                TestSourceKey.SeveralReturnsWithFirstWorking => 
                    new List<bool>() { false, false, false, true, true, true, true, true, true, true, false, false, 
                        false },
